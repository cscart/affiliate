...
{capture name="banner_content"}
    {if $banner_type == "iframe_content" || $banner_type == "js_content"}
        ...
        {elseif $banner_data.type == "P"}
            ...
            <tr>
                <td class="{$banner_data.align}" style="padding: 5px 10px;">
            ...
            <tr>
                <td class="strong {$banner_data.align}" style="padding: 5px 10px;">
                    <a href="{$banner_data.banner_url}" style="text-decoration: underline;" target={if $banner_data.new_window == "Y" || $banner_type == "iframe_content"}_blank{else}_self{/if}><strong>{$banner_data.product}</strong></a>
                </td>
            </tr>
            {/capture}
            ...
            <tr>
                <td style="padding: 5px 10px;">
                    {if $banner_data.product_short_description}
